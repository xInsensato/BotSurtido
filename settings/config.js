module.exports = {
  TOKEN: process.env.TOKEN || "MTExMDE1MjI0OTQ4Njg2ODUxMA.GX4JEU.0ORPSbJOWRKKxSl0Wr6SEYRnK7Q5JVwZIvMAlE",
  PREFIX: process.env.PREFIX || "1110152249486868510",
  embed: {
    color: process.env.color || "#ff0000",
    wrongcolor: process.env.wrongcolor || "#ff0000",
    footertext: "Insensato_ Developer",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
